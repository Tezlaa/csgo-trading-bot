...
async def set_link(msg: types.Message, state: FSMContext):
    if msg.text == "💸Курс":
        await msg.answer("🔥Цены🔥                    💸Курс💸\n\n1Р - 1.03₽ (на баланс  steam)\n\n"
                         "🍯100Р - 103₽                 1.03\n"
                         "🍯200Р - 206₽                 1.03\n"
                         "🍯300Р- 309₽                  1.03\n"
                         "🍯400Р - 412₽                 1.03\n"
                         ...
                         "🍯3000Р - 3090₽             1.03\n"
                         "🍯5000Р - 5150₽             1.03\n\n"
                         "❗️Комиссия рынка на нас\n\n"
                         "📍Пополнение возможно в любом количестве от 100Р!")
        await msg.answer('Для продолжения операции отправьте вашу трейд-ссылку следующим сообщением⤵',
                         reply_markup=go_to_main_menu)
        return
    elif msg.text == "❓Где взять трейд-ссылку?":
